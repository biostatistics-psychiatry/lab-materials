...
Under additivity, the treatment effect is assumed the same in Low and High depression, and the depression effect is assumed the same in both treatment groups.
...
## 7.1 Group means (additive vs interaction model)
