...
# One Binary and One Numeric Predictor without Interaction (Additive Model)
...
## Predicted means for each treatment group (averaged over PHQ-9)
...
## Conditional treatment effects at selected PHQ-9 values
...
# Quantile Regression with One Binary and One Numeric Predictor
...
## Conditional median treatment effects at selected PHQ-9 values
...
## Marginal median treatment effect
...
## Predicted means across PHQ-9 (additive model)
...
## Predicted means across PHQ-9 (interaction model)
...
## Visualizing the conditional treatment effect across PHQ-9
...
## Visualizing conditional treatment effects at three PHQ-9 levels
