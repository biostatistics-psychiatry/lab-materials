...
That describes the same model, but highlights that the individual predictions, denoted by $i$, are a function of the predictors (in this case only the intercept), $\beta_0$, and the individual deviations from the predicted value, $\varepsilon_i$, also known as the residuals.
