...
To participate in the lab sessions, you need to install R and RStudio on your computer. You can download R from [CRAN](https://cran.r-project.org/) and RStudio from [RStudio](https://www.rstudio.com/products/rstudio/download/). Both are free to use.
...
![R console default](images/r-console-default.jpeg)
