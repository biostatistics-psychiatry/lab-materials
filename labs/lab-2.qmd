...
In this lab we will practice calculating and interpreting descriptive statistics and summary measures using the STePS dataset. We start by loading the dataset you cleaned during the previous lab:
...
## Exercise: Get an overview of the dataset
