...
## Exercise: Import the STePS dataset
...
When working with data in your research projects, it's a good idea to save your data in formats that can be reused later. This is especially important if you are working with large datasets, as it can be time-consuming to re-import the data every time you want to use it.

In this course we are using an open dataset, but for your own projects you may want to save your data on KI server or another secure location.
