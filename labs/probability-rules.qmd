...
Let's look at how we can implement probability rules in R and apply them to our dataset. In a previous lab, we created some categorical variables at baseline. These were just simulated, so we will not try to make sense of the results.
