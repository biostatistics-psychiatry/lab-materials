...
This lab is linked to the [Import and clean data](../labs/import-clean.qmd) chapter. We will look at some common steps involved in importing and cleaning data, such as fixing column names, missing values, and column types.
